...
| U17b | UMA runtime trial | AI | M | ❌ **stopped** | log S14. **Vendoring rejected on evidence** — 1.6 GB, 0.75% framework, licence not uniform. D-W24/D-W25. **Owner decision needed** |
